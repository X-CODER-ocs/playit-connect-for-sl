# playit connect for SL

> [`playit.gg`](https://playit.gg) 官方 [`playit-agent`](https://github.com/playit-cloud/playit-agent)
> 源码的独立内置副本，供 [SulfurLauncher](https://github.com/X-CODER-ocs/SulfurBlockLauncher)
> 内置「playit connect for SL」联机功能使用。本仓库不保存上游 git 历史，作为一个可独立构建
> 的附属仓库维护，可整体拉取上游更新。
